...
- The main [StreamsHub site](https://github.com/streamshub/streamshub-site) can be configured to pull the entire `docs` folder and construct a static-site, starting with the `docs/_index.md`.
